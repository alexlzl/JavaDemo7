...
public class Test2 {
    public static void main(String[] args) {
        Member[] members = {new Member("Justin", 90),
                ...
                new Member("Bush", 88)};
        try {
            DataOutputStream dataOutputStream = new DataOutputStream(new FileOutputStream("E:\\test\\test1.txt"));
            ...
            DataInputStream dataInputStream = new DataInputStream(new FileInputStream("E:\\test\\test1.txt"));
